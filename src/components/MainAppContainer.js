...
const MainAppContainer = React.createClass({
		...
		var date = (this.props.date && this.props.month)?`${months[this.props.month]} ${this.props.date} ${this.props.year}`: ''; 
		...
		var dateHeader = (<h1 style={dateStyle}>{date}</h1>);
		if(games && games.length){
			...
			var introduction = (this.props.date =="")?(
				<div className="row">
				<p style={{marginLeft:'auto', marginRight:'auto'}}>To find MLB games and more information.</p>
				</div>
				):''
